...
public class CoordenadorController {
    ...
    @GetMapping("{id}")
    @PreAuthorize("hasAuthority('SCOPE_COORDENADOR') and #id.toString() == authentication.principal.claims['sub']")
    ...
    @PreAuthorize("hasAuthority('SCOPE_COORDENADOR') and #idProfissional.toString() == authentication.principal.claims['sub']")
    public ResponseEntity<ProfissionalDTO> getCoordenadorById(@PathVariable Integer idProfissional, JwtAuthenticationToken token){
        ProfissionalDTO coordenador = cadastroService.getCoordenadorById(idProfissional, token);
